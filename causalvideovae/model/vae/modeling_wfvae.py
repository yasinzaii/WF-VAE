...
class WFVAEModel(VideoBaseAE):
    ...
    def forward(self, input, sample_posterior=True):
        ...
        posterior, (enc_l1, enc_l2) = encode_output.latent_dist, encode_output.extra_output
        ...
        return ForwardOutput(sample=dec, latent_dist=posterior, extra_output=(enc_l1, dec_l1, enc_l2, dec_l2))
